...
echo finalGrade(100, 12). "<br>";  // 100
echo finalGrade(99, 0). "<br>";    // 100
echo finalGrade(10, 15). "<br>";   // 100
echo finalGrade(85, 5). "<br>";    // 90
echo finalGrade(55, 3). "<br>";    // 75
echo finalGrade(55, 0). "<br>";    // 0
echo finalGrade(20, 2). "<br>";    // 0